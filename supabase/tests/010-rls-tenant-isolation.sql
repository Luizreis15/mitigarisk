...
savepoint before_wrong_tenant_audit_event;
do $$
begin
...
$$;
rollback to savepoint before_wrong_tenant_audit_event;
...
savepoint before_auditor_membership_insert;
do $$
begin
...
$$;
rollback to savepoint before_auditor_membership_insert;
