...
insert into public.tenants (id, name, slug, status) values
  ('10000000-0000-0000-0000-000000000001', 'Fictional Fintech Ltda', 'fictional-fintech', 'active'),
  ('10000000-0000-0000-0000-000000000002', 'Sample Payments Co', 'sample-payments', 'active')
on conflict (id) do nothing;
